      ...
      >
        ...
        <div className="max-w-xl text-center lg:text-left">
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-6 leading-tight text-gray-800">
            <span className="text-indigo-600">Effortless</span> Group Expense
            Tracking
          </h2>
          <p className="text-lg text-gray-600 mb-8">
            Track expenses, split bills, and stay financially aligned with your
            friends and groups — all in one place.
          </p>
        ...
        {/* Animation */}
        <div className="w-full max-w-lg lg:max-w-lg  rounded-xl p-4">
          <Player
            autoplay
            loop
