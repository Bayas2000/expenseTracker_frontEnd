...
const Goals = () => {
  ...
  const scheduledExpenses = [
    { name: "Rent", amount: 1200, dueDate: "5th" },
    { name: "Netflix", amount: 499, dueDate: "10th" },
    { name: "Netflix", amount: 499, dueDate: "10th" },
    { name: "Netflix", amount: 99, dueDate: "10th" },
    { name: "Netflix", amount: 19, dueDate: "10th" },
  ];

  const totalScheduled = scheduledExpenses.reduce(
  ...
  const pieData = [
    ...
    { name: "Scheduled Expense", value: totalScheduled },
    {
            ...
            <div className="flex flex-col lg:flex-row gap-6 mt-3 ">
              ...
              <div className="lg:w-1/3 w-full bg-white border rounded-md shadow-md h-[300px] overflow-y-auto">
                ...
                <ul className="space-y-3 text-sm px-5 py-2">
                  {scheduledExpenses.map((item, index) => (
                    <li
                      key={index}
