...
//       className=" fixed flex items-center justify-center inset-0 z-100 p-8 bg-black/50 "
//     >
//       <div
//         // ref={modalRef}
  ...
  return (
    <div className="fixed flex items-center justify-center inset-0 z-100 p-4 sm:p-8 bg-black/50">
      <div className="bg-white bg-opacity-90 backdrop-blur-md rounded-2xl shadow-2xl w-full max-w-sm p-6 sm:p-8">
        <div className="text-center mb-6">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800">INVESTMATE</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="username" className="block text-gray-700 font-medium mb-1 text-sm sm:text-base">
              Username
            </label>
            <input
              id="username"
